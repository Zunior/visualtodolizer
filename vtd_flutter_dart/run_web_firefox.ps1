# PowerShell script for Visual Todo Lizer Flutter app - Web version (Firefox)
...
Write-Host "Visual Todo Lizer - Flutter Web App (Firefox)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
# Run the app on web (Firefox)
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Starting web app in Firefox..." -ForegroundColor Cyan
Write-Host "This may take a few minutes on first run..." -ForegroundColor Yellow
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

& $flutterPath run -d firefox
...
if ($LASTEXITCODE -ne 0) {
    ...
    Write-Host "1. Make sure Firefox is installed"
